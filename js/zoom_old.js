...
(function($) {
	$().ready(function() {
		...
		zoom.area = '<div id="zoom"><div id="zoom_controls"class="ui-widget ui-corner-all" style="width:800px"><div class="slider_left_label">x1</div><div id="zoom_slider"></div><div class="slider_right_label">x10</div></div><canvas id="zoom_area" height="400" width="800"></canvas></div>';
	})})(jQuery);
function zoom_activate() {
	(function($) {
		...
		source_canvas.toggle(function(){
			...
			zoom_window.redraw($("#image_to_analyze")[0].getContext("2d"));
		},
		function() {
